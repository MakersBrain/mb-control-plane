...
export const REDIRECT_URI=import.meta.env.VITE_OIDC_REDIRECT_URI || (import.meta.env.DEV?'http://localhost:4175/oauth/callback':'https://app.makersbrain.app/oauth/callback');
export const ACCOUNT_URL=trim(import.meta.env.VITE_ACCOUNT_URL || (import.meta.env.DEV?'http://rauthy.localhost:8092':'https://auth.makersbrain.app'));
