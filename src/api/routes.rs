...
public_routes! {
    ...
    "/v1/platform/workshops/{id}/webshop", true => [get(webshop::platform_get)];
    ...
    "/v1/workshops/{id}/webshop", true => [get(webshop::get)];
    "/v1/workshops/{id}/webshop/onboarding/refresh", true => [post(webshop::refresh)];
    "/v1/workshops/{id}/webshop/onboarding/complete", true => [post(webshop::complete)];
    "/v1/workshops/{id}/webshop/deactivate", true => [post(webshop::deactivate)];
    ...
    "/v1/workshops/{id}/domains", true => [get(domains::list), post(domains::create)];
    "/v1/workshops/{id}/domains/{domain_id}/verify", true => [post(domains::verify)];
    "/v1/workshops/{id}/domains/{domain_id}/canonical", true => [post(domains::make_canonical)];
    "/v1/workshops/{id}/domains/{domain_id}", true => [delete(domains::disconnect)];
    "/v1/workshops/{id}/email-domains", true => [get(email_domains::list), post(email_domains::create)];
    "/v1/workshops/{id}/email-domains/{domain_id}/check", true => [post(email_domains::check)];
    "/v1/workshops/{id}/email-domains/{domain_id}", true => [delete(email_domains::disconnect)];
    "/v1/workshops/{id}/email/smtp", true => [get(smtp::get), post(smtp::configure), delete(smtp::reset)];
