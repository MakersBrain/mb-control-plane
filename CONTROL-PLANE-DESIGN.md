# MakersBrain control-plane design (historical)

Status: superseded

This file previously described the proposed extraction of the control plane
from `../makersbrain`. That extraction has been completed and the old proposal
