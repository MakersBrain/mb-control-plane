...
write_secret CONTROL_RAUTHY_ADMIN_KEY "mb-runtime\$$(random_hex)"
write_secret CONTROL_RAUTHY_DEPLOYMENT_KEY "mb-deployment\$$(random_hex)"
...
for optional_secret in \
  ...
  INVENTORY_GEMINI_KEY INVENTORY_CLAUDE_KEY \
...
write_named_secret control_inventory_database_url "postgresql://control_inventory_worker:$control_inventory_password@postgres:5432/mb_control"
write_named_secret control_email_database_url "postgresql://control_email_worker:$control_email_password@postgres:5432/mb_control"
write_named_secret control_reconciliation_database_url "postgresql://control_reconciliation_worker:$control_reconciliation_password@postgres:5432/mb_control"
write_named_secret control_lifecycle_database_url "postgresql://control_lifecycle_worker:$control_lifecycle_password@postgres:5432/mb_control"
write_named_secret control_backup_database_url "postgresql://control_backup_scheduler:$control_backup_password@postgres:5432/mb_control"
write_named_secret control_driver_database_url "postgresql://control_driver_ledger:$control_driver_password@postgres:5432/mb_control"
write_named_secret control_release_database_url "postgresql://control_release_worker:$control_release_password@postgres:5432/mb_control"
write_named_secret control_privacy_database_url "postgresql://control_privacy_worker:$control_privacy_password@postgres:5432/mb_control"
